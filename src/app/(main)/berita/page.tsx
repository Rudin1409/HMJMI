    ...
    <div className="flex flex-col">
      <section className="relative w-full flex items-center justify-center min-h-screen py-20 bg-transparent overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10 w-full">
          <ScrollAnimation direction="down" className="inline-block">
            <Badge variant="outline" className="mb-6 border-primary/50 text-white bg-primary/10 px-6 py-2 text-base font-semibold rounded-full hover:scale-105 transition-transform">
              Kabar Terkini
            </Badge>
          </ScrollAnimation>
          ...
          <ScrollAnimation delay={1}>
            <h1 className="text-5xl md:text-7xl font-extrabold text-foreground mb-6 tracking-tight">
              Pusat Informasi & <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-blue-600">Wawasan</span>
            </h1>
          </ScrollAnimation>
      ...
      <section id="berita-content" className="w-full py-16 md:py-24 bg-primary/40">
