...
export default function ProkerPage() {
  return (
    <div className="flex flex-col">
      <section 
        id="hero-proker" 
        className="relative w-full bg-gradient-to-b from-pink-100/50 to-background flex items-center justify-center min-h-[70vh] py-20"
      >
      ...
      <section id="proker-list" className="w-full py-16 md:py-24 bg-gradient-to-b from-background to-pink-50/30">
        <div className="container mx-auto px-4">
          <Tabs defaultValue="unggulan" className="w-full">
            ...
            <TabsContent value="unggulan">
              <Card className="w-full max-w-5xl mx-auto shadow-2xl rounded-3xl overflow-hidden border-2 border-primary/20 bg-white">
            ...
            <TabsContent value="pengembangan">
                 <Card className="w-full max-w-5xl mx-auto shadow-xl rounded-3xl overflow-hidden bg-white">
