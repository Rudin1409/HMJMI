...
const teamMembers = {
  ...
  humas: {
     heads: [
        { name: 'Masya Dinar Fadillah', role: 'Kepala Departemen', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Muhamad Rifky Septiansyah', role: 'Wakil Kepala Departemen', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Panisah', role: 'Sekretaris', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Ajeng Alieffiyah Safitri', role: 'Bendahara', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Zakira Surani', role: 'Koordinator Kominfo', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Vanessa Septia Putri', role: 'Koordinator Medkraf', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Nailah Zhafirah Cahyalia Jaya', role: 'Koordinator Jurnalis', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
     ],
    members: {
      kominfo: [
          { name: 'Arien Salsabila Basurini', role: 'Anggota Kominfo', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
          { name: 'Nadi Kurniawan', role: 'Anggota Kominfo', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
      ...
      medkraf: [
          { name: 'M. Dandi Firjatullah', role: 'Anggota Medkraf', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
      ...
      jurnalis: [
          { name: 'Regas Sonjaya', role: 'Anggota Jurnalis', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
  ...
  psdm: {
      heads: [
        { name: 'Muhammad Naufal Athallah', role: 'Kepala Departemen', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Aulia Niputri', role: 'Wakil Kepala Departemen', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Sri Rahayu Rezeki', role: 'Sekretaris', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Shoofiyah Maharani', role: 'Bendahara', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: 'Handika Putra', role: 'Koordinator Minat Bakat', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
        { name: '????', role: 'Koordinator Bidang HRD PSDM', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
      ],
    members: {
      minatbakat: [
          { name: 'Swarnata Prayoga', role: 'Anggota Minat Bakat', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
          { name: 'Nurhaliza', role: 'Anggota Minat Bakat', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
          { name: 'Nanda Meylani Putri', role: 'Anggota Minat Bakat', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
          { name: 'Luluk Anggraini', role: 'Anggota Minat Bakat', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
          { name: 'Ridho Dwi Restiandi', role: 'Anggota Minat Bakat', class: 'MI 2024', avatar: 'https://placehold.co/400x400.png', instagram: "-" },
