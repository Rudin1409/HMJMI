  ...
  humas: {
    ...
    members: {
      kominfo: [
          ...
          { name: 'Fajar Setyanusa', role: 'Anggota kominfo', class: 'MI 2025', avatar: '/anggota/humas25/Fajar Setyanusa (2).png', instagram: "https://www.instagram.com/adawn_n/" },
          { name: 'Nafi Julian Syam Fajri', role: 'Anggota Kominfo', class: 'MI 2025', avatar: '/anggota/humas25/Nafi Julian Syam Fajri (2).png', instagram: "https://www.instagram.com/_nafijulian/" },
          { name: 'Diana Mareta', role: 'Anggota Kominfo', class: 'MI 2025', avatar: '/anggota/humas25/Diana Mareta (2).png', instagram: "https://www.instagram.com/_aattaaa/" },
          { name: 'Anggun Ayu Tria Rahmah', role: 'Anggota Kominfo', class: 'MI 2025', avatar: '/anggota/humas25/Anggun Ayu Tria Rahmah (2).png', instagram: "https://www.instagram.com/anggunayutriaa/" },
      ],
      medkraf: [
          { name: 'Muhammad Nabil Fadhilah', role: 'Anggota Medkraf', class: 'MI 2025', avatar: '/anggota/humas25/naabil (2).png' },
          { name: 'Finolia Rama Danti', role: 'Anggota Medkraf', class: 'MI 2025', avatar: '/anggota/humas25/Finolia Rama Danti (2).png', instagram: "https://www.instagram.com/finnn0_0/" },
          { name: 'Nuril Maghfiroh', role: 'Anggota Medkraf', class: 'MI 2025', avatar: '/anggota/humas25/Nuril Maghfiroh (2).png', instagram: "https://www.instagram.com/nuril_mghkamil02/" },
          { name: 'Helza Framesha', role: 'Anggota Medkraf', class: 'MI 2025', avatar: '/anggota/humas25/HelzaFramesha (2).png', instagram: "https://www.instagram.com/zeshakun_/" },
          { name: 'Thomas Kristalio Ariflan Santos', role: 'Anggota Medkraf', class: 'MI 2025', avatar: '/anggota/humas25/Thomas Kristalio (2).png', instagram: "https://www.instagram.com/thomas6kasp/" },
      ],
      jurnalis: [
