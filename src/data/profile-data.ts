...
export const teamMembers = {
  ...
  kesma: {
      heads: [
        { name: 'Muhamad Rizqon Yasir', role: 'Kepala Departemen', class: 'MI 2024', avatar: '/anggota/kesma24/M.RIZQON YASIR.png', instagram: "-" },
        { name: 'Zalsabila Herawaty', role: 'Wakil Kepala Departemen', class: 'MI 2024', avatar: '/anggota/kesma24/ZALSABILA HERAWATY.png', instagram: "-" },
        { name: 'Aisyah Arianti', role: 'Sekretaris', class: 'MI 2024', avatar: '/anggota/kesma24/AISYAH ARIANTI.png', instagram: "-" },
        { name: 'Azzahra Dinda Febrianti', role: 'Bendahara', class: 'MI 2024', avatar: '/anggota/kesma24/AZZAHRA DINDA FEBRIANTI.png', instagram: "-" },
        { name: 'Muhammad Sutan Artha', role: 'Koordinator Agama', class: 'MI 2024', avatar: '/anggota/kesma24/M.SUTAN ARTHA.png', instagram: "-" },
        { name: 'Adhyaksa Micko Satria', role: 'Koordinator Sosial', class: 'MI 2024', avatar: '/anggota/kesma24/ADHYAKSA MICKO SATRIA.png', instagram: "-" },
      ],
    members: {
      agama: [
        { name: 'Annisa Nurhidayah', role: 'Anggota Agama', class: 'MI 2024', avatar: '/anggota/kesma24/ANNISA NURHIDAYAH.png', instagram: "-" },
      ...
      sosial: [
        { name: 'Dimas Fajar Satrio', role: 'Anggota Sosial', class: 'MI 2024', avatar: '/anggota/kesma24/DIMAS FAJAR SATRIO.png', instagram: "-" },
        { name: 'Jessica Imelda Septriani', role: 'Anggota Sosial', class: 'MI 2024', avatar: '/anggota/kesma24/Jessica.png', instagram: "-" },
        { name: 'Muhammad Rifki Surya Pratama', role: 'Anggota Sosial', class: 'MI 2024', avatar: '/anggota/kesma24/M.RIFKY.png', instagram: "-" },
        { name: 'Tarisha Bais Husna', role: 'Anggota Sosial', class: 'MI 2024', avatar: '/anggota/kesma24/TARISHA BAIS HUSNA.png', instagram: "-" },
  ...
  bistra: {
      heads: [
        { name: 'Mochamad Raechan Albani', role: 'Kepala Departemen', class: 'MI 2024', avatar: '/anggota/bistra24/RAECHAN ALBANI.png', instagram: "-" },
        { name: 'Rahmi Fauliza Hanapsari', role: 'Wakil Kepala Departemen', class: 'MI 2024', avatar: '/anggota/bistra24/RAHMI FAULIZA HANAPSARI.png', instagram: "-" },
        { name: 'Adellia Nurain', role: 'Sekretaris', class: 'MI 2024', avatar: '/anggota/bistra24/ADELLIA NURAIN.png', instagram: "-" },
        { name: 'Liana Melisa', role: 'Bendahara', class: 'MI 2024', avatar: '/anggota/bistra24/LIANA MELISA.png', instagram: "-" },
        { name: 'Dani Maulana', role: 'Koordinator Bisnis', class: 'MI 2024', avatar: '/anggota/bistra24/DANI MAULANA.png', instagram: "-" },
        { name: 'Natasya Bella Shavira', role: 'Koordinator Kemitraan', class: 'MI 2024', avatar: '/anggota/bistra24/NATASHA BELLA SHAVIRA.png', instagram: "-" },
      ],
    members: {
      bisnis: [
        { name: 'Henny Daraditha Salsabilla', role: 'Anggota Bisnis', class: 'MI 2024', avatar: '/anggota/bistra24/HENNY DARADHITA SALSABILLA.png', instagram: "-" },
        { name: 'Tri Aji Alhuda', role: 'Anggota Bisnis', class: 'MI 2024', avatar: '/anggota/bistra24/TRI AJI ALHUDA.png', instagram: "-" },
      ...
      kemitraan: [
        { name: 'Aldi Kurniawan', role: 'Anggota Kemitraan', class: 'MI 2024', avatar: '/anggota/bistra24/ALDI KURNIAWAN.png', instagram: "-" },
        { name: 'Sharla Imanda', role: 'Anggota Kemitraan', class: 'MI 2024', avatar: '/anggota/bistra24/SHARLA IMANDA.png', instagram: "-" },
